...
namespace dotnetapp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LifeDbContext>(opt => opt.UseSqlServer(connectionString));
           // services.AddScoped<IProductService, ProductService>();
            services.AddScoped<IAuth , Auth>();
            services.AddScoped<IAdmin, AdminServices>();
services.AddScoped<IAuth, Auth>();
services.AddScoped<PolicyCore>();
services.AddScoped<IUser, User>();
services.AddScoped<IPlan, PlanServices>();
services.AddScoped< DocumentServices>();
services.AddScoped<IPolicy,PolicyCore>();
            services.AddCors();
